...
public class DataBase {
    ...
    public Cursor getDishes()
    {
        switch (dishSortId)
        {
            case 1 : return mDB.query(DISH_TABLE, null, null, null, null, null, DISH_COLUMN_NAME);
            case 2 : return mDB.query(DISH_TABLE, null, null, null, null, null, DISH_COLUMN_CALORIES_PER_100_GM);
        }
    ...
    {
        addDish(dish.getName(), dish.getCalories_per_100_gm());
    }
    ...
    {
        updateDish(dish.getName(), dish.getCalories_per_100_gm());
    }
    ...
    public Cursor getExercises()
    {
        ...
        {
            case 1 : return mDB.query(EXERCISE_TABLE, null, null, null, null, null, EXERCISE_COLUMN_NAME);
            case 2 : return mDB.query(EXERCISE_TABLE, null, null, null, null, null, EXERCISE_COLUMN_TIME_COEFF);
            case 3 : return mDB.query(EXERCISE_TABLE, null, null, null, null, null, EXERCISE_COLUMN_QUANTITY_COEFF);
        }
